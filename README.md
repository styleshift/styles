...
| **Component** | **Description**              | **Styles** | **React** | **Blade** | **CSS** |
| ------------- | ---------------------------- | ---------- | --------- | --------- | ------- |
| Form          | A container for form inputs  | ❌         | ❌        | ❌        | ❌      |
| Field         | A wrapper for form inputs    | ❌         | ❌        | ❌        | ❌      |
...
| **Component**     | **Description**                      | **Styles** | **React** | **Blade** | **CSS** |
| ----------------- | ------------------------------------ | ---------- | --------- | --------- | ------- |
| Header Navigation | Top-level navigation menu            | ❌         | ❌        | ❌        | ❌      |
| Mobile Header     | Mobile-optimized navigation header   | ❌         | ❌        | ❌        | ❌      |
| Bottom Navigation | Navigation at the bottom of viewport | ❌         | ❌        | ❌        | ❌      |
...
| Page Control  | Controls for paginated content    | ❌         | ❌        | ❌        | ❌      |
| Pagination    | Numeric pagination for navigation | ❌         | ❌        | ❌        | ❌      |
...
| Collapsible        | Content that can expand or collapse     | ❌         | ❌        | ❌        | ❌      |
| Drag and Drop List | Reorderable list via drag-and-drop      | ❌         | ❌        | ❌        | ❌      |
| Preview Card       | Card for previewing content             | ❌         | ❌        | ❌        | ❌      |
| Message Card       | Card for displaying brief messages      | ❌         | ❌        | ❌        | ❌      |

### Hierarchical Content

| **Component** | **Description**                   | **Styles** | **React** | **Blade** | **CSS** |
| ------------- | --------------------------------- | ---------- | --------- | --------- | ------- |
| Tree View     | Hierarchical view of data         | ❌         | ❌        | ❌        | ❌      |
| Layout Grid   | Grid-based layout system          | ❌         | ❌        | ❌        | ❌      |
| Tile          | Visual container for content      | ❌         | ❌        | ❌        | ❌      |
| List          | Ordered or unordered list display | ❌         | ❌        | ❌        | ❌      |
...
| Empty State    | Display for no data or empty results       | ❌         | ❌        | ❌        | ❌      |
| Notification   | Notifications with user actions            | ❌         | ❌        | ❌        | ❌      |
...
| Snackbar       | Short messages displayed briefly           | ❌         | ❌        | ❌        | ❌      |
| Spinner        | Circular loading indicator                 | ❌         | ❌        | ❌        | ❌      |
| Toast          | Notifications that disappear automatically | ❌         | ❌        | ❌        | ❌      |
